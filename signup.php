...
<script src ="./js/signuperrors.js"></script>
          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="./includes/signup.inc.php" method = "post">
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                  <input name="repwd" type="password" id="repwd" class="form-control form-control-lg" />
                  <label class="form-label" for="form3Example4cdg">Repeat your password</label>
                </div>

                <div data-mdb-input-init class="form-outline mb-4">
                  <input name="tele" type="number" id="form3Example1cg" class="form-control form-control-lg" />
                  <label class="form-label" for="form3Example1cg">Telephone</label>
                </div>

                <div data-mdb-input-init class="form-outline mb-4">
                  <input name="nic" type="text" id="form3Example1cg" class="form-control form-control-lg" />
                  <label class="form-label" for="form3Example1cg">NIC</label>
                </div>
                ...
                <div class="d-flex justify-content-center">
                  <button type="submit" name="btnSignup" onclick="check();"
